...
var all_pages = [["Stop one activity before completing it.","Take time to consider all aspects.","Think before doing.","Stop and think.","Fast and careless.","Never reckless.","Buy something without thinking.","Value rational approach."],["Spur of the moment.","Careful reasoning.","Not as cautious.","Cautious person.","Spontaneous person.","Do first thing that comes to mind.","Close track of money.","Play things by ear."],["Know how to proceed.","Very level-headed.","Organize my work.","Often start projects.","I am methodical.","Not have detailed plans.","Have a good idea of what I'm going to do.","Like to find out what to expect."]]
...
var survey_block = {
  ...
  reverse_score: [[false, true, true, true, false, true, false, true],[false, true, false, true, false, false, true, false],[true, true, true, false, true, false, true, true]],
};
