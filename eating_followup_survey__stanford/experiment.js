...
function addID() {
  jsPsych.data.addDataToLastTrial({exp_id: 'eating_followup_survey__stanford'})
}
...
/* ************************************ */
var preFileType = "<img class = center src='/static/experiments/eating_followup_survey__stanford/images/"
var pathSource = "/static/experiments/eating_followup_survey__stanford/images/"
...
var eating_followup_survey__stanford_experiment = []

eating_followup_survey__stanford_experiment.push(welcome_block);

eating_followup_survey__stanford_experiment.push(instructions_block);

eating_followup_survey__stanford_experiment.push(update_state_block);

eating_followup_survey__stanford_experiment.push(post_questionnaire_node);

eating_followup_survey__stanford_experiment.push(end_block);