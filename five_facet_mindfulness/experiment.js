...
var fmi_scale = {"Rarely": 1, "Occasionally":2, "Fairly Often":3, "Almost always":4}
var mq_opts = ["agree totally", "agree mostly", "agree somewhat","neutral", "disagree somewhat","disagree mostly","disagree totally"]
var mq_scale = {"agree totally":7, "agree mostly":6, "agree somewhat":5,"neutral":4, "disagree somewhat":3,"disagree mostly":2,"disagree totally":1}
var kims_opts = ["never or very rarely true", "seldom true", "sometimes true", "often true","always or almost always true"]
var kims_scale = {"never or very rarely true":1, "seldom true":2, "sometimes true":3, "often true":4,"always or almost always true":5}
var maas_opts = ["almost always", "very frequently", "somewhat frequently", "somewhat infrequently", "very infrequently", "almost never"]
var maas_scale = {"almost always":1, "very frequently": 2, "somewhat frequently": 3, "somewhat infrequently": 4, "very infrequently": 5, "almost never": 6}
var cams_opts = ["rarely/not at all", "sometimes","often", "almost always"]
var cams_scale = {"rarely/not at all":1, "sometimes":2,"often":3, "almost always":4}
...
var score_scale = [[fmi_scale, fmi_scale, fmi_scale, mq_scale, mq_scale, mq_scale, mq_scale],fillArray(kims_scale,8),[maas_scale, maas_scale, maas_scale, maas_scale, maas_scale, kims_scale, kims_scale, cams_scale],[kims_scale, kims_scale, kims_scale, kims_scale, kims_scale, kims_scale, cams_scale],[kims_scale, kims_scale, kims_scale, kims_scale, kims_scale, kims_scale, kims_scale, mq_scale]]
