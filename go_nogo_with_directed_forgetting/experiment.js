...
var getCategorizeFeedback = function () {
  ...
  if (
    ...
    jsPsych.data.getDataByTrialIndex(curr_trial).go_nogo_condition != "nogo"
  ) {
    if (
...
var createTrialTypes = function (numTrialsPerBlock) {
  ...
  for (
    ...
    numIterations <
    numTrialsPerBlock /
      (go_nogo_conditions.length * directed_cond_array.length);
    numIterations++
  ) {
    for (
      ...
      for (
        var numgo_nogoConds = 0;
        numgo_nogoConds < go_nogo_conditions.length;
        numgo_nogoConds++
      ) {
...
var getDirectedCueStim = function () {
  ...
  return (
    go_nogo_boards[0] + preFileType + cue + fileTypePNG + go_nogo_boards[1]
  );
};
...
var preFileType =
  "<img class = center src='/static/experiments/go_nogo_with_directed_forgetting/images/";
...
var task_boards = [
  [
    '<div class = bigbox><div class = lettersBox><div class = topLeft style="font-size:50px;"><div class = fixation>',
  ],
  [
...
var go_nogo_boards = [
  [
    '<div class = bigbox><div class = centerbox><div class = cue-text><font size = "10" color = "',
  ],
  ['">'],
  ["</font><div></div><div>"],
];
...
var instructions_block = {
  ...
  pages: [
    ...
    "<div class = centerbox>" +
      "<p class = block-text>On some trials, the probe will be " +
      go_no_go_styles[1] +
      ", instead of " +
      go_no_go_styles[0] +
      ".</p>" +
      "<p class = block-text>If the letter is " +
      go_no_go_styles[1] +
      ", please do not respond on that trial!</p>" +
      "<p class = block-text>An " +
      go_no_go_styles[1] +
      " letter will be grey outlined in black.</p>" +
      "<p class = block-text>A " +
      go_no_go_styles[0] +
...
var start_test_block = {
  ...
  text:
    "<div class = centerbox>" +
    "<p class = block-text>We will now start the test portion. You will be presented with " +
    numLetters +
    ...
    "<p class = block-text>This will instruct you to <i>FORGET</i> the " +
    numLetters / 2 +
    ...
    possible_responses[1][0] +
    "  </i>if not.</p>" +
    "<p class = block-text>Only respond if the probe was " +
    go_no_go_styles[0] +
    ", not " +
    go_no_go_styles[1] +
    "!</p>" +
...
var start_fixation_block = {
  type: "poldrack-single-stim",
  stimulus:
    '<div class = centerbox><div class = fixation><span style="color:none">+</span></div></div>',
  is_html: true,
  choices: "none",
  data: {
    trial_id: "fixation",
