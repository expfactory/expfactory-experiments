...
var getCategorizeFeedback = function(){
	...
	if ((trial_id == 'practice_trial') && (jsPsych.data.getDataByTrialIndex(curr_trial).go_nogo_condition != 'nogo')){
...
var getDirectedCueStim = function(){
	...
	return go_nogo_boards[0]+ preFileType + cue + fileTypePNG + go_nogo_boards[1]
}
...
var feedback_text = 
	'Welcome to the experiment. This task will take about 30 minutes. Press <i>enter</i> to begin.'
var feedback_block = {
...
var start_test_block = {
	...
	text: '<div class = centerbox>'+
			'<p class = block-text>We will now start the test portion. You will be presented with '+numLetters+' letters on each trial. You must memorize all '+numLetters+' letters.</p> '+
