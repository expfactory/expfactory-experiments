...
var pathSource =
  "/static/experiments/n_back_with_predictable_task_switching/images/";
var fileTypePNG = ".png'></img>";
var preFileType =
  "<img class = center src='/static/experiments/n_back_with_predictable_task_switching/images/";
...
var prompt_text =
  ...
  '<p class = center-block-text style = "font-size:16px; line-height:80%%;">Top 2 quadrants: match the current letter to the letter that appeared ' +
  predictable_dimensions[0][1] +
  " trial(s) ago</p>" +
  '<p class = center-block-text style = "font-size:16px; line-height:80%%;">Bottom 2 quadrants: match the current letter to the letter that occurred ' +
  predictable_dimensions[2][1] +
  " trial(s) ago</p>" +
  "<p>&nbsp</p>" +
