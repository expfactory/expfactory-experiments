...
function addID() {
  jsPsych.data.addDataToLastTrial({'exp_id': 'local_global'})
}
...
var instructions_block = {
  ...
  pages: [
	...
	'<div class = centerbox><p class = block-text>For instance, for the shape below you would press 3 because it is ' + task_colors[1] + ' which means you should respond based on the smaller shapes. If the shape was instead ' + task_colors[0] + ' you would press 2.</p><div class = instructionImgBox><img src = "static/experiments/local_global/images/' + task_colors[1] + '_Xoftriangles.png" height = 200 width = 200></img></div></div>'
	],
  allow_keys: false,
