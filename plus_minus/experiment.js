...
var add_block = {
    type: 'survey-text',
    questions: [add_list],
    data: {'exp_id': 'plus-minus', 'condition': 'add', 'trial_id': 'test'}
};

var minus_block = {
    type: 'survey-text',
    questions: [add_list],
    data: {'exp_id': 'plus-minus', 'condition': 'subtract', 'trial_id': 'test'}
};

var alternate_block = {
    type: 'survey-text',
    questions: [alternate_list],
    data: {'exp_id': 'plus-minus', 'condition': 'alternate', 'trial_id': 'test'}
};

var posttask_questionnaire = {
    type: 'survey-text',
    questions: [['Did you use a numpad?']],
    data: {'exp_id': 'plus-minus', 'trial_id': 'post-task questionnaire'}
};
