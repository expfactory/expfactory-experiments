...
var instructions_block = {
  type: 'instructions',
  pages: [
    '<div class = centerbox><p class = block-text>For each of the following statements, please indicate the descriptive they are of you.<br><br> Press <strong>enter</strong> to begin.</p></div>',
  ],
  key_forward: 13,
...
//Set up experiment
var grit_s_experiment = []
grit_s_experiment.push(welcome_block);
grit_s_experiment.push(instructions_block);
grit_s_experiment.push(survey_block);
grit_s_experiment.push(end_block);