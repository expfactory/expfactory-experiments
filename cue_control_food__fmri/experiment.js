...
function addID() {
  jsPsych.data.addDataToLastTrial({exp_id: 'cue_control_food__fmri', subject_ID: subject_ID})
}
...
var preFileType = "<img class = center src='/static/experiments/cue_control_food__fmri/images/"
...
var cue_control_food__fmri_experiment = []

cue_control_food__fmri_experiment.push(welcome_block);

cue_control_food__fmri_experiment.push(check_finger_node);

cue_control_food__fmri_experiment.push(instructions_block);

cue_control_food__fmri_experiment.push(experimentor_wait_block);

cue_control_food__fmri_experiment.push(scanner_wait_block_first);

cue_control_food__fmri_experiment.push(scanner_wait_block_second);

cue_control_food__fmri_experiment.push(scanner_wait_block_third);

cue_control_food__fmri_experiment.push(training_node);

cue_control_food__fmri_experiment.push(end_block);
