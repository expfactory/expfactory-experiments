...
var getBoard = function(board_type) {
	...
	if (board_type == 2) {
		...
		board += "<div class = square><input type='image' class = card_image id = " + i +
			" src='/static/experiments/columbia_card_task_hot/images/beforeChosen.png' onclick = instructCard(this.id)></div>"
		}
		...
		board += "<div class = square><input class = card_image type='image' id = " + i +
			" src='/static/experiments/columbia_card_task_hot/images/beforeChosen.png' onclick = chooseCard(this.id)></div>"
		}
	}
	board += "</div>"
...
var getRound = function() {
	if (roundOver === 0) { //this is for the start of a round
		...
		for (i = 0; i < clickedGainCards.length; i++) {
			gameState = appendTextAfter2(gameState, "id = " + "" + clickedGainCards[i] + ""," src='/static/experiments/columbia_card_task_hot/images/chosen.png'", " src='/static/experiments/columbia_card_task_hot/images/beforeChosen.png' onclick = chooseCard(this.id)")
		}
		return gameState
		...
		for (i = 0; i < whichGainCards.length; i++) {
			gameState = appendTextAfter2(gameState, "id = " + "" + whichGainCards[i] + ""," src='/static/experiments/columbia_card_task_hot/images/chosen.png'", " src='/static/experiments/columbia_card_task_hot/images/beforeChosen.png' onclick = chooseCard(this.id)")
		}
		for (i = 0; i < whichLossCards.length; i++) {
			gameState = appendTextAfter2(gameState, "id = " + "" + whichLossCards[i] + ""," src='/static/experiments/columbia_card_task_hot/images/loss.png'", " src='/static/experiments/columbia_card_task_hot/images/beforeChosen.png' onclick = chooseCard(this.id)")
		}
		return gameState
	}
}
