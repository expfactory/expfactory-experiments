...
var getCategorizeFeedback = function () {
  ...
  if (
    ...
    jsPsych.data.getDataByTrialIndex(curr_trial).stop_signal_condition == "go"
  ) {
    if (
...
var preFileType =
  "<img class = center src='/static/experiments/stop_signal_single_task_network/images/";
...
var practice_intro = {
  type: "poldrack-single-stim",
  stimulus:
    "<div class = centerbox><p class = block-text>We will now start the practice for the experiment.<br><br>For these trials, you must press the <i>" +
    possible_responses[0][0] +
    "</i>, " +
    " or <i>" +
    possible_responses[2][0] +
    " </i>depending on the shape of the stimulus.  Make sure to respond as quickly and accurately as possible to the shape. <br><br> The responses for each shape are as follows: " +
    prompt_text +
...
var feedback_text =
  "We will start practice. During practice, you will receive a prompt to remind you of the rules.  <i>This prompt will be removed for test!</i> Press <i>enter</i> to begin.";
var feedback_block = {
  type: "poldrack-single-stim",
  data: {
...
var test_intro = {
  ...
  stimulus:
    "<div class = centerbox>" +
    "<p class = block-text>We will now begin the test portion. To summarize the instructions...</p>" +
  ...
  on_finish: function () {
    feedback_text =
      "We will now start the test session. Please concentrate on responding quickly and accurately to each stimulus. Press Enter to begin.";
  },
};
...
var practiceStopNode = {
  ...
  loop_function: function (data) {
    ...
    if (
      aveShapeRespondCorrect > accuracy_thresh &&
...
var testNode = {
  ...
  loop_function: function (data) {
    ...
    if (testCount == numTestBlocks) {
      feedback_text +=
        "</p><p class = block-text>Done with this test. If you have been completing tasks continuously for an hour or more, please take a 15-minute break before starting again.";
