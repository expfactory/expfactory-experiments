...
/* ************************************ */
function addID() {
  jsPsych.data.addDataToLastTrial({exp_id: 'object_recognition'})
}
...
var preFileType = "<img class = center src='/static/experiments/object_recognition/images/"
...
var object_recognition_experiment = [];
object_recognition_experiment.push(visualCheckNode);
