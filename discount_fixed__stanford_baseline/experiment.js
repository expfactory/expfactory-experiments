...
/* ************************************ */
function addID() {
  jsPsych.data.addDataToLastTrial({exp_id: 'discount_fixed__stanford_baseline'})
}
...
//Set up experiment
var discount_fixed__stanford_baseline_experiment = []
discount_fixed__stanford_baseline_experiment.push(welcome_block);
discount_fixed__stanford_baseline_experiment.push(instructions_block);

// practice portion
discount_fixed__stanford_baseline_experiment.push(start_practice_block);
discount_fixed__stanford_baseline_experiment.push(delay_trial_block);
for (i = 0; i < practice_options.small_amt.length; i++) {
  ...
  discount_fixed__stanford_baseline_experiment.push(practice_block)
}


// test portion
discount_fixed__stanford_baseline_experiment.push(start_test_block);
discount_fixed__stanford_baseline_experiment.push(delay_trial_block);
...
for (x = 0; x < test_stim_index.length; x++) {	
	...
	discount_fixed__stanford_baseline_experiment.push(test_block)
	if ((x%60 === 0) && (x > 0)) {
		discount_fixed__stanford_baseline_experiment.push(rest_block)
		discount_fixed__stanford_baseline_experiment.push(attention_node)
		discount_fixed__stanford_baseline_experiment.push(attn_check_start_test)
	}
}
discount_fixed__stanford_baseline_experiment.push(post_task_block);
discount_fixed__stanford_baseline_experiment.push(end_block);