...
function addID() {
  jsPsych.data.addDataToLastTrial({exp_id: 'smoking_followup_survey__stanford'})
}
...
/* ************************************ */
var preFileType = "<img class = center src='/static/experiments/smoking_followup_survey__stanford/images/"
var pathSource = "/static/experiments/smoking_followup_survey__stanford/images/"
...
var smoking_followup_survey__stanford_experiment = []

smoking_followup_survey__stanford_experiment.push(welcome_block);

smoking_followup_survey__stanford_experiment.push(instructions_block);

smoking_followup_survey__stanford_experiment.push(update_state_block);

smoking_followup_survey__stanford_experiment.push(post_questionnaire_node);

smoking_followup_survey__stanford_experiment.push(end_block);