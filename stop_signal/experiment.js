...
var welcome_block = {
  type: 'poldrack-text',
  data: {exp_id: "stop_signal", trial_id: "welcome"},
...
var end_block = {
  type: 'poldrack-text',
  data: {exp_id: "stop_signal", trial_id: "end"},
  timing_response: 60000,
...
var fixation_block = {
  ...
  is_html: true,
  choices: 'none',
  data: {exp_id: "stop_signal", trial_id: "fixation", exp_stage: "test"},
  timing_post_trial: 0,
  timing_stim: 500,
  timing_response: 500
}
...
var prompt_fixation_block = {
  ...
  is_html: true,
  choices: 'none',
  data: {exp_id: "stop_signal", trial_id: "fixation", exp_stage: "practice"},
  timing_post_trial: 0,
  timing_stim: 500,
  timing_response: 500,
  prompt: prompt_text
...
var practice_feedback_block = {
  type: 'poldrack-text',
  data: {exp_id: "stop_signal", trial_id: "feedback"},
  timing_response: 60000,
  cont_key: [13],
...
var test_feedback_block = {
  type: 'poldrack-text',
  data: {exp_id: "stop_signal", trial_id: "feedback", exp_stage: "test"},
...
for (c = 0; c< numconditions; c++) {
	...
	for (b = 0; b< numblocks; b++) {
		...
		var block = blocks[b]
		if (ss_freq == "high") {
			var stop_trials = jsPsych.randomization.repeat(['stop','stop','go','go','go'],test_block_len/5)
		} else {
			var stop_trials = jsPsych.randomization.repeat(['stop','go','go','go','go'],test_block_len/5)
		}
		...
		for (i = 0; i < test_block_len; i++) {
			...
			var stop_signal_block = {
			  ...
			  on_finish: function(data) {
			  	updateSSD(data)
			  	jsPsych.data.addDataToLastTrial({condition: ss_freq, trial_id: 'stim', exp_stage: 'test'}) 
