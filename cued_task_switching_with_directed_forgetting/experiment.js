...
var preFileType =
  "<img class = center src='/static/experiments/cued_task_switching_with_directed_forgetting/images/";
...
var pathSource =
  "/static/experiments/cued_task_switching_with_directed_forgetting/images/";
var images = [];
...
var instructions_block = {
  ...
  pages: [
    "<div class = centerbox>" +
      ...
      "<p class = block-text>If you see the cue, " +
      cued_dimensions[0] +
      ", please  <i>" +
      cued_dimensions[0] +
      "</i> the cued set.</p>" +
...
var start_test_block = {
  ...
  text:
    ...
    ", please  <i>" +
    cued_dimensions[0] +
    "</i> the top or bottom letters.</p>" +
    "<p class = block-text>If you see the cue, " +
    cued_dimensions[1] +
    ", please  <i>" +
    cued_dimensions[1] +
    "</i> the top or bottom.</p>" +
    "<p class = block-text>After, you will be presented with a probe (single letter).  Please indicate whether this probe was in your memory set.</p>" +
    "<p class = block-text>Press the <i>" +
    possible_responses[0][0] +
    "  </i>if the probe was in the memory set, and the <i>" +
