...
function addID() {
  jsPsych.data.addDataToLastTrial({exp_id: 'screening_survey'})
}
...
/* ************************************ */
var preFileType = "<img class = center src='/static/experiments/screening_survey/images/"
var pathSource = "/static/experiments/screening_survey/images/"
...
var survey_questions = ['Have you ever had a stroke?',
...
var item_names_dartmouth = ['stroke',
							'neurological',
							'english']
...
var instructions_block = {
	...
	text: '<div class = centerbox>'+
			'<p class = block-text style="font-size:28px"><font color="white">Before starting the study, please answer the following questions. </font></p>' +
...
var screening_survey_experiment = []

screening_survey_experiment.push(welcome_block);

screening_survey_experiment.push(instructions_block);

screening_survey_experiment.push(update_state_block);

screening_survey_experiment.push(post_questionnaire_node);

screening_survey_experiment.push(end_block);
