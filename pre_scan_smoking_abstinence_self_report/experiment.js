...
//does the question require buttons, textfield, numeric, or time?  only have coded for radio and time					    
...
var textBoard = '<div class = textbox>'+
					 '<textarea id="question_text_area" cols="10" rows="1" value=""></textarea>'+
					 '<div class = submitbox><input type="submit" value="Submit" data-inline="true" onClick="pressSubmit(document.getElementById(\'question_text_area\'))"/></div>' +
				'</div></div>'
	
var timeBoard = '<div class = textbox>'+
					 '<input style="font-size:36px;" type="time" id="question_text_area" name="appt" min="0:00" max="24:00" required>'+
					 '<div class = submitbox><input type="submit" value="Submit" data-inline="true" onClick="submitTime(document.getElementById(\'question_text_area\'))"/></div>' +
				'</div></div>'	
