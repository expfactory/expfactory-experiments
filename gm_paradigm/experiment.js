...
var getStopSignal = function(){
	...
	stopStim= {image: preFileStopType+pathSource+ colors[temp]+'_stopSignal'+fileType+postFileType, data: {exp_id: 'gmParadigm', stop_stim: "", correct_response: "", stop_color_condition: ""}}
	currData= stopStim.data
  }
}
...
var appendForcedChoiceData = function(){
	...
	if(whichKey==37){
	jsPsych.data.addDataToLastTrial({chosenStim: whichSquare, chosenCond: firstCond, chosenGo_Stop: firstSS, stimLeft: whichSquare, cond_left: firstCond, go_stop_left: firstSS, stimRight: whichSquare2,  cond_right: secCond, go_stop_right: secondSS, current_trial: currTrial})
	} else if(whichKey==39){
	jsPsych.data.addDataToLastTrial({chosenStim: whichSquare2, chosenCond: secCond, chosenGo_Stop: secondSS, stimLeft: whichSquare, cond_left: firstCond, go_stop_left: firstSS, stimRight: whichSquare2,  cond_right: secCond, go_stop_right: secondSS, current_trial: currTrial})
	} else if(whichKey==-1){
	jsPsych.data.addDataToLastTrial({chosenStim: "", chosenCond: "", chosenGo_Stop: "", stimLeft: whichSquare, cond_left: firstCond, go_stop_left: firstSS, stimRight: whichSquare2,  cond_right: secCond, go_stop_right: secondSS, current_trial: currTrial})
	}	
	currTrial = currTrial +1
}
...
var numTrials = 80
var currTrial = 0
var pathSource = '/Users/jamieli/Desktop/jamie/experimentImages/gmParadigm/'
var fileType = '.png'
...
var forced_choice_intro_break = {
  type: 'single-stim',
  stimuli: '<div class = centerbox><p class = block-text>We will now take a short break.  <br><br>Press <strong>enter</strong> to continue.</p></div>',
  is_html: true,
  choices: 13,
  data: {exp_id: "gmParadigm", "trial_id": "forced_choice_intro"},
  timing_post_trial: 0,
...
var fixationBlock = {
  type: 'single-stim',
  stimuli: '<div class = centerbox><div class = fixation-gmParadigm><span style="color:red">+</span></div></div>',
  is_html: true,
  choices: 'none',
...
var pre_practice_learning_block1 = {
  type: 'single-stim',
  stimuli: prompt_practice_text_heading1 + tempText1  + practiceLearningStims1.image,
  is_html: true,
  choices: 13,
...
var pre_practice_learning_block2 = {
  type: 'single-stim',
  stimuli: prompt_practice_text_heading1 + tempText2  + practiceLearningStims2.image,
  is_html: true,
  choices: 13,
  data: {exp_id: "gmParadigm", "trial_id": "Learning Phase Instructions"},
  timing_post_trial: 0,
...
var pre_practice_learning_block3 = {
  type: 'single-stim',
  stimuli: prompt_practice_text_heading1 + tempText3  + practiceLearningStims3.image,
  is_html: true,
  choices: 13,
  data: {exp_id: "gmParadigm", "trial_id": "Learning Phase Instructions"},
  timing_post_trial: 0,
...
var pre_practice_learning_block4 = {
  type: 'single-stim',
  stimuli: prompt_practice_text_heading1 + tempText4  + practiceLearningStims4.image,
  is_html: true,
  choices: 13,
  data: {exp_id: "gmParadigm", "trial_id": "Learning Phase Instructions"},
  timing_post_trial: 0,
...
var pre_practice_learning_block5 = {
  type: 'single-stim',
  stimuli: prompt_practice_text_heading1 + tempText5  + practiceLearningStims5.image,
  is_html: true,
  choices: 13,
  data: {exp_id: "gmParadigm", "trial_id": "Learning Phase Instructions"},
  timing_post_trial: 0,
...
var pre_practice_learning_block7 = {
  type: 'single-stim',
  stimuli: prompt_practice_text_heading1 + tempText7  + practiceLearningStims7.image,
  is_html: true,
  choices: 13,
  data: {exp_id: "gmParadigm", "trial_id": "Learning Phase Instructions"},
  timing_post_trial: 0,
...
var pre_practice_learning_block8 = {
  type: 'single-stim',
  stimuli: prompt_practice_text_heading1 + tempText8  + practiceLearningStims8.image,
  is_html: true,
  choices: 13,
  data: {exp_id: "gmParadigm", "trial_id": "Learning Phase Instructions"},
  timing_post_trial: 0,
...
gmParadigm_experiment.push(welcome_block)
gmParadigm_experiment.push(instructions_block)
//practice learning associations (pre-phase 1)
gmParadigm_experiment.push(pre_practice_learning_block1)
gmParadigm_experiment.push(start_practice)
gmParadigm_experiment.push(learning_chunk1)
gmParadigm_experiment.push(learning_chunk1_2)

gmParadigm_experiment.push(pre_practice_learning_block2)
gmParadigm_experiment.push(start_practice)
gmParadigm_experiment.push(learning_chunk2)
gmParadigm_experiment.push(learning_chunk2_2)


gmParadigm_experiment.push(pre_practice_learning_block3)
gmParadigm_experiment.push(start_practice)
gmParadigm_experiment.push(learning_chunk3)
gmParadigm_experiment.push(learning_chunk3_2)


gmParadigm_experiment.push(pre_practice_learning_block4)
gmParadigm_experiment.push(start_practice)
gmParadigm_experiment.push(learning_chunk4)
gmParadigm_experiment.push(learning_chunk4_2)


gmParadigm_experiment.push(pre_practice_learning_block5)
gmParadigm_experiment.push(start_practice)
gmParadigm_experiment.push(learning_chunk5)
gmParadigm_experiment.push(learning_chunk5_2)


gmParadigm_experiment.push(pre_practice_learning_block6)
gmParadigm_experiment.push(start_practice)
gmParadigm_experiment.push(learning_chunk6)
gmParadigm_experiment.push(learning_chunk6_2)


gmParadigm_experiment.push(pre_practice_learning_block7)
gmParadigm_experiment.push(start_practice)
gmParadigm_experiment.push(learning_chunk7)
gmParadigm_experiment.push(learning_chunk7_2)


gmParadigm_experiment.push(pre_practice_learning_block8)
gmParadigm_experiment.push(start_practice)
gmParadigm_experiment.push(learning_chunk8)
gmParadigm_experiment.push(learning_chunk8_2)

//learning phase (phase 1)
gmParadigm_experiment.push(start_test)
gmParadigm_experiment.push(learning_chunk)
gmParadigm_experiment.push(reset_Trial)
gmParadigm_experiment.push(learning_feedback_block)
gmParadigm_experiment.push(bonus_block)

//practice stop first session (pre-phase 2)
gmParadigm_experiment.push(stop_intro)
gmParadigm_experiment.push(practiceStopChunk)
gmParadigm_experiment.push(practice_feedback_block);
gmParadigm_experiment.push(reset_Trial)

//practice stop second session (pre-phase 2)
gmParadigm_experiment.push(stop_intro2)
gmParadigm_experiment.push(practice_chunk)
gmParadigm_experiment.push(practice_feedback_block);
gmParadigm_experiment.push(reset_SSD)
gmParadigm_experiment.push(reset_Trial)

//stopping phase (phase 2)
gmParadigm_experiment.push(main_stop_intro1)
gmParadigm_experiment.push(test_chunk)
gmParadigm_experiment.push(reset_Trial)

//forced choice phase (phase 3)
gmParadigm_experiment.push(forced_choice_intro)
for(forcedChoice=0;forcedChoice<5;forcedChoice++){
gmParadigm_experiment.push(fixationBlock)
gmParadigm_experiment.push(forced_choice_block)
} 
gmParadigm_experiment.push(reset_Trial)

gmParadigm_experiment.push(forced_choice_intro_break)
for(forcedChoice=0;forcedChoice<5;forcedChoice++){
gmParadigm_experiment.push(fixationBlock)
gmParadigm_experiment.push(forced_choice_block2)
}
gmParadigm_experiment.push(bonus_block)
gmParadigm_experiment.push(end_block)
