...
var appendPracticeStopData = function(){
	jsPsych.data.addDataToLastTrial({trial_id: "practice_stop", subject_ID: subjectID, stim: practice_trial_data.stimulus, condition: practice_trial_data.condition, stop_stim: stop_signal, stop_condition: "neutral", current_trial: currTrial})
	currTrial = currTrial+1
