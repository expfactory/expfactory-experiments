...
var calculateResponses = function(){
	var sum_rt = 0;
        var sumGo_correct = 0;
        var go_length = 0;
		var num_responses = 0;
...
return average_rt
return averageGo_correct
return missed_responses
return averageStop_correct
return sumGo_correct
return go_length
return num_responses
return sumStop_correct
return stop_length
}
...
var testImagesBlock = {
  type: 'text',
  text: preFileType+pathSource+'green_circle'+fileType+postFileType+preFileType+pathSource+'minus_25'+fileType+postFileType+'<div class = fixation-gmParadigm><span style="color:red">+</span></div>',
  cont_key: [13],
  timing_post_trial: 0,
};
