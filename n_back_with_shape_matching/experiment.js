...
var createTrialTypes = function (numTrialsPerBlock, delay) {
  first_stims = [];
  for (var i = 0; i < 3; i++) {
    // i can now take 0, 1, or 2 as its value. This's because there can be three possible first trials that have no previous match (i.e. delay = 1, 2, or 3).
    if (i < delay) {
...
var preFileType =
  "<img class = center src='/static/experiments/n_back_with_shape_matching/images/";
var preFileTypeDistractor =
  "<img class = distractor src='/static/experiments/n_back_with_shape_matching/images/";
...
var start_test_block = {
  ...
  on_finish: function () {
    feedback_text =
      ...
      delay +
      ". Please match the current white letter to the letter that appeared " +
      delay +
