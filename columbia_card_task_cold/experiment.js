...
var instructButton = function(clicked_id){
	currID = parseInt(clicked_id)
	document.getElementById(clicked_id).src='/static/experiments/columbia_card_task_cold/images/chosen.png';
}
...
var instructFunction = function(){
	document.getElementById("c1").src='/static/experiments/columbia_card_task_cold/images/chosen.png';
	document.getElementById("c17").src='/static/experiments/columbia_card_task_cold/images/chosen.png';
	document.getElementById("c18").src='/static/experiments/columbia_card_task_cold/images/chosen.png';
	document.getElementById("c15").src='/static/experiments/columbia_card_task_cold/images/chosen.png';
	document.getElementById("c27").src='/static/experiments/columbia_card_task_cold/images/chosen.png';
	document.getElementById("c31").src='/static/experiments/columbia_card_task_cold/images/chosen.png';
	document.getElementById("c8").src='/static/experiments/columbia_card_task_cold/images/chosen.png';
...
var instructFunction2 = function(){
	document.getElementById("c1").src='/static/experiments/columbia_card_task_cold/images/chosen.png';
	document.getElementById("c4").src='/static/experiments/columbia_card_task_cold/images/chosen.png';
	document.getElementById("c30").src='/static/experiments/columbia_card_task_cold/images/chosen.png';
	document.getElementById("c13").src='/static/experiments/columbia_card_task_cold/images/loss.png';
...
var instructTurnCard = function(){
	...
	document.getElementById("c3").src='/static/experiments/columbia_card_task_cold/images/chosen.png';
	document.getElementById("c5").src='/static/experiments/columbia_card_task_cold/images/chosen.png';
	document.getElementById("c6").src='/static/experiments/columbia_card_task_cold/images/chosen.png';
	document.getElementById("c7").src='/static/experiments/columbia_card_task_cold/images/chosen.png';
	document.getElementById("c9").src='/static/experiments/columbia_card_task_cold/images/chosen.png';
	document.getElementById("c10").src='/static/experiments/columbia_card_task_cold/images/chosen.png';
	document.getElementById("c11").src='/static/experiments/columbia_card_task_cold/images/chosen.png';
	document.getElementById("c12").src='/static/experiments/columbia_card_task_cold/images/chosen.png';
	document.getElementById("c19").src='/static/experiments/columbia_card_task_cold/images/chosen.png';
	document.getElementById("c14").src='/static/experiments/columbia_card_task_cold/images/chosen.png';
	document.getElementById("c15").src='/static/experiments/columbia_card_task_cold/images/chosen.png';
	document.getElementById("c16").src='/static/experiments/columbia_card_task_cold/images/chosen.png';
	document.getElementById("c17").src='/static/experiments/columbia_card_task_cold/images/chosen.png';
	document.getElementById("c18").src='/static/experiments/columbia_card_task_cold/images/chosen.png';
	document.getElementById("c20").src='/static/experiments/columbia_card_task_cold/images/chosen.png';
	document.getElementById("c21").src='/static/experiments/columbia_card_task_cold/images/chosen.png';
	document.getElementById("c22").src='/static/experiments/columbia_card_task_cold/images/chosen.png';
	document.getElementById("c23").src='/static/experiments/columbia_card_task_cold/images/chosen.png';
	document.getElementById("c24").src='/static/experiments/columbia_card_task_cold/images/chosen.png';
	document.getElementById("c25").src='/static/experiments/columbia_card_task_cold/images/chosen.png';
	document.getElementById("c26").src='/static/experiments/columbia_card_task_cold/images/chosen.png';
	document.getElementById("c27").src='/static/experiments/columbia_card_task_cold/images/chosen.png';
	document.getElementById("c28").src='/static/experiments/columbia_card_task_cold/images/chosen.png';
	document.getElementById("c29").src='/static/experiments/columbia_card_task_cold/images/chosen.png';
	document.getElementById("c31").src='/static/experiments/columbia_card_task_cold/images/chosen.png';
