...
var chooseButton = function(clicked_id) {
	...
	if ($('#feedback').length) {
		document.getElementById("feedback").innerHTML =
			...
			' cards. <strong>You turned over ' + num_gain_cards + ' gain card(s) and ' + num_loss_cards +
			' loss card(s)</strong>. Your score has been updated to reflect these cards. When you click on the "Next" button, the next round starts. Please note that the loss amount, the gain amount, and the number of loss cards might have changed.'
	}
}
...
var shuffledParamsArray = jsPsych.randomization.repeat(paramsArray, numRounds/27)
...
var instructions_block = {
  ...
  pages: [
	...
	'<p>-You will play a total of 27 rounds, three of which will be randomly selected at the end of the session, and you will get a bonus payment proportional to those rounds.</p>',
