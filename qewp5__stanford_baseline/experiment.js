...
function addID() {
  jsPsych.data.addDataToLastTrial({exp_id: 'qewp5__stanford_baseline'})
}
...
/* ************************************ */
var preFileType = "<img class = center src='/static/experiments/qewp5__stanford_baseline/images/"
var pathSource = "/static/experiments/qewp5__stanford_baseline/images/"
...
var qewp5__stanford_baseline_experiment = []

qewp5__stanford_baseline_experiment.push(welcome_block);

qewp5__stanford_baseline_experiment.push(instructions_block);

qewp5__stanford_baseline_experiment.push(update_state_block);

qewp5__stanford_baseline_experiment.push(post_questionnaire_node);

qewp5__stanford_baseline_experiment.push(end_block);