...
/* ************************************ */
function addID() {
  jsPsych.data.addDataToLastTrial({exp_id: 'discount_fixed__dartmouth_baseline'})
}
...
var test_stim_index_list = [[37,94,77,60,79,31,110,74,27,19,95,113,5,76,75,36,24,106,0,50,23,86,73,12,52,40,67,93,109,14,41,102,2,42,84,55,30,38,4,92,101,98,90,32,68,45,29,111,81,16,103,47,43,99,104,72,22,6,80,96,66,34,48,17,70,46,54,89,107,57,7,64,44,53,117,87,85,21,58,18,49,63,59,1,115,13,119,8,116,71,28,108,100,56,9,65,51,33,62,82,25,112,91,20,15,39,35,97,105,61,11,118,83,114,69,26,88,10,78,3],
							[28,108,100,56,9,65,51,33,62,82,25,112,91,20,15,39,35,97,105,61,11,118,83,114,69,26,88,10,78,3,37,94,77,60,79,31,110,74,27,19,95,113,5,76,75,36,24,106,0,50,23,86,73,12,52,40,67,93,109,14,41,102,2,42,84,55,30,38,4,92,101,98,90,32,68,45,29,111,81,16,103,47,43,99,104,72,22,6,80,96,66,34,48,17,70,46,54,89,107,57,7,64,44,53,117,87,85,21,58,18,49,63,59,1,115,13,119,8,116,71],
						    [66,34,48,17,70,46,54,89,107,57,7,64,44,53,117,87,85,21,58,18,49,63,59,1,115,13,119,8,116,71,28,108,100,56,9,65,51,33,62,82,25,112,91,20,15,39,35,97,105,61,11,118,83,114,69,26,88,10,78,3,37,94,77,60,79,31,110,74,27,19,95,113,5,76,75,36,24,106,0,50,23,86,73,12,52,40,67,93,109,14,41,102,2,42,84,55,30,38,4,92,101,98,90,32,68,45,29,111,81,16,103,47,43,99,104,72,22,6,80,96],
						    [41,102,2,42,84,55,30,38,4,92,101,98,90,32,68,45,29,111,81,16,103,47,43,99,104,72,22,6,80,96,66,34,48,17,70,46,54,89,107,57,7,64,44,53,117,87,85,21,58,18,49,63,59,1,115,13,119,8,116,71,28,108,100,56,9,65,51,33,62,82,25,112,91,20,15,39,35,97,105,61,11,118,83,114,69,26,88,10,78,3,37,94,77,60,79,31,110,74,27,19,95,113,5,76,75,36,24,106,0,50,23,86,73,12,52,40,67,93,109,14]]

var test_ITIs = test_ITIs_list[trial_order]
var test_stim_index = test_stim_index_list[trial_order]
...
var rest_block = {
  ...
  stimulus: '<div class = centerbox>'+
  				...
  				'<p class = block-text>As a reminder, if you want the option on the screen, please press the left arrow key. If you want to accept $20 today, press the down arrow key.</p>'+
  			'</div>',
  is_html: true,
  choices: [13],
  response_ends_trial: true,
...
//Set up experiment
var discount_fixed__dartmouth_baseline_experiment = []
discount_fixed__dartmouth_baseline_experiment.push(welcome_block);
discount_fixed__dartmouth_baseline_experiment.push(instructions_block);

// practice portion
discount_fixed__dartmouth_baseline_experiment.push(start_practice_block);
discount_fixed__dartmouth_baseline_experiment.push(delay_trial_block);
for (i = 0; i < practice_options.small_amt.length; i++) {
  ...
  discount_fixed__dartmouth_baseline_experiment.push(practice_block)
}


// test portion
discount_fixed__dartmouth_baseline_experiment.push(start_test_block);
discount_fixed__dartmouth_baseline_experiment.push(delay_trial_block);
...
for (x = 0; x < test_stim_index.length; x++) {	
	...
	discount_fixed__dartmouth_baseline_experiment.push(test_block)
	if ((x%60 === 0) && (x > 0)) {
		discount_fixed__dartmouth_baseline_experiment.push(rest_block)
		discount_fixed__dartmouth_baseline_experiment.push(attention_node)
		discount_fixed__dartmouth_baseline_experiment.push(attn_check_start_test)
	}
}
discount_fixed__dartmouth_baseline_experiment.push(post_task_block);
discount_fixed__dartmouth_baseline_experiment.push(end_block);