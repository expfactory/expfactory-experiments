...
var test_attn_check_experiment = [];
for (var i = 0; i < experiment_len; i++) {
  test_attn_check_experiment.push(test_block);
}
test_attn_check_experiment.push(attention_node)
test_attn_check_experiment.push(attention_node)
test_attn_check_experiment.push(attention_node)
test_attn_check_experiment.push(attention_node)
test_attn_check_experiment.push(attention_node)
...
test_attn_check_experiment.push(post_task_block)
test_attn_check_experiment.push(end_block);