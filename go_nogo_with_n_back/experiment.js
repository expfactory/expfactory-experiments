...
var start_test_block = {
	...
	text: '<div class = centerbox>'+
			...
			'<p class = block-text><i>Please make no response if the '+go_no_go_styles[1]+' version of the letter came out.  You must still commit that letter to memory!</i></p>'+
			'<p class = block-text>Capitalization does not matter, so "T" matches with "t".</p> '+
...
var feedback_text = 
'Welcome to the experiment. This task will take about 12.5 minutes. Press <i>enter</i> to begin.'
var feedback_block = {
