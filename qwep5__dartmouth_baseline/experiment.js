...
function addID() {
  jsPsych.data.addDataToLastTrial({exp_id: 'qwep5__dartmouth_baseline'})
}
...
/* ************************************ */
var preFileType = "<img class = center src='/static/experiments/qwep5__dartmouth_baseline/images/"
var pathSource = "/static/experiments/qwep5__dartmouth_baseline/images/"
...
var item_names_dartmouth = ['qwep8_bl',
							'qwep9_bl',
							'qwep10_bl',
							'qwep_11_header_bl',
							'qwep11a_bl',
...
var end_block = {
	type: 'poldrack-text',
	data: {
		exp_id: "qwep5__dartmouth_baseline",
		trial_id: "end"
	},
...
var qwep5__dartmouth_baseline_experiment = []

qwep5__dartmouth_baseline_experiment.push(welcome_block);

qwep5__dartmouth_baseline_experiment.push(instructions_block);

qwep5__dartmouth_baseline_experiment.push(update_state_block);

qwep5__dartmouth_baseline_experiment.push(post_questionnaire_node);

qwep5__dartmouth_baseline_experiment.push(end_block);