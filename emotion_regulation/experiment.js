...
function addID() {
  jsPsych.data.addDataToLastTrial({'exp_id': 'emotion_regulation'})
}
...
var getChoiceText = function() {
  ...
  var choice_text = '<div class = leftBox><div class = center-text>' + options[0] + '</div></div>' + '<div class = rightBox><div class = center-text>' + options[1] + '</div></div>' 
  return choice_text
}
...
if (Math.random() < 0.5) {
  ...
  trainingVars.instruction.push('reappraise'); trainingVars.intense.push('high');
} else {
  trainingVars.instruction.push('reappraise'); trainingVars.intense.push('low');
  trainingVars.instruction.push('reappraise'); trainingVars.intense.push('high');
  trainingVars.instruction.push('distract'); trainingVars.intense.push('low');
...
var practiceVars = jsPsych.randomization.repeat([{instruction:'choose', intense: 'high'},
                                                {instruction:'choose', intense: 'high'},
                                                {instruction:'choose', intense: 'low'},
                                                {instruction:'choose', intense: 'low'},
                                                {instruction:'distract', intense: 'high'},
                                                {instruction:'distract', intense: 'low'},
                                                {instruction:'reappraise', intense: 'high'},
                                                {instruction:'reappraise', intense: 'low'}],1,true)
setImage()
...
var training_instruct = {
  type: 'poldrack-text',
  data: {trial_id: 'instruction', exp_stage: 'training'},
  cont_key: [13],
...
var training_view = {
  ...
  is_html: true,
  data: {trial_id: 'stim-view', exp_stage: 'training'},
  choices: 'none',
  timing_stim: 15000,
...
var practice_instruct = {
  type: 'poldrack-text',
  data: {trial_id: 'instruction', exp_stage: 'practice'},
  cont_key: [13],
...
var practice_view = {
  ...
  is_html: true,
  data: {trial_id: 'stim-view', exp_stage: 'practice'},
  choices: 'none',
  timing_stim: 5000,
...
var preview_block = {
  ...
  stimulus: getImage,
  is_html: true,
  data: {trial_id: 'stim-preview', exp_stage: 'test'},
  choices: 'none',
  timing_stim: 500,
  timing_response: 500,
  timing_post_trial: 0
...
var choice_block = {
  ...
  choices: choices,
  is_html: true,
  data: {trial_id: 'choice', exp_stage: 'test'},
  response_ends_trial: true,
  timing_post_trial: 0
}
...
var view_block = {
  ...
  stimulus: getImage,
  is_html: true,
  data: {trial_id: 'stim-view', exp_stage: 'test'},
  choices: 'none',
  timing_stim: 5000,
  timing_response: 5000,
  timing_post_trial: 1000,
