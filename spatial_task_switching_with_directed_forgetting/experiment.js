...
/* ************************************ */
function addID() {
  jsPsych.data.addDataToLastTrial({exp_id: 'spatial_task_switching_with_directed_forgetting'})
}
...
var getTrainingStim = function(){
	return task_boards[whichQuadrant - 1][0]+preFileType+letters[0]+fileTypePNG+
		   task_boards[whichQuadrant - 1][1]+
		   task_boards[whichQuadrant - 1][2]+preFileType+letters[1]+fileTypePNG+
		   task_boards[whichQuadrant - 1][3]+preFileType+letters[2]+fileTypePNG+
		   task_boards[whichQuadrant - 1][4]+
		   task_boards[whichQuadrant - 1][5]+preFileType+letters[3]+fileTypePNG+
		   task_boards[whichQuadrant - 1][6]

}

var getCueStim = function(){
	return center_boards[whichQuadrant - 1][0] + preFileType + cue + fileTypePNG + center_boards[whichQuadrant - 1][1]
}

var getProbeStim = function(){
	return center_boards[whichQuadrant - 1][0] + preFileType + probe + fileTypePNG + center_boards[whichQuadrant - 1][1]	
...
var preFileType = "<img class = center src='/static/experiments/spatial_task_switching_with_directed_forgetting/images/"
...
var task_boards = [[['<div class = bigbox><div class = quad_box><div class = decision-top-left><div class = lettersBox><div class = topLeft style="font-size:50px;"><div class = cue-text>'],['</div></div><div class = topMiddle style="font-size:50px;"><div class = cue-text>'],['</div></div><div class = topRight style="font-size:50px;"><div class = cue-text>'],['</div></div><div class = bottomLeft style="font-size:50px;"><div class = cue-text>'],['</div></div><div class = bottomMiddle style="font-size:50px;"><div class = cue-text>'],['</div></div><div class = bottomRight style="font-size:50px;"><div class = cue-text>'],['</div></div></div></div></div>']],
				   [['<div class = bigbox><div class = quad_box><div class = decision-top-right><div class = lettersBox><div class = topLeft style="font-size:50px;"><div class = cue-text>'],['</div></div><div class = topMiddle style="font-size:50px;"><div class = cue-text>'],['</div></div><div class = topRight style="font-size:50px;"><div class = cue-text>'],['</div></div><div class = bottomLeft style="font-size:50px;"><div class = cue-text>'],['</div></div><div class = bottomMiddle style="font-size:50px;"><div class = cue-text>'],['</div></div><div class = bottomRight style="font-size:50px;"><div class = cue-text>'],['</div></div></div></div></div>']],
				   [['<div class = bigbox><div class = quad_box><div class = decision-bottom-right><div class = lettersBox><div class = topLeft style="font-size:50px;"><div class = cue-text>'],['</div></div><div class = topMiddle style="font-size:50px;"><div class = cue-text>'],['</div></div><div class = topRight style="font-size:50px;"><div class = cue-text>'],['</div></div><div class = bottomLeft style="font-size:50px;"><div class = cue-text>'],['</div></div><div class = bottomMiddle style="font-size:50px;"><div class = cue-text>'],['</div></div><div class = bottomRight style="font-size:50px;"><div class = cue-text>'],['</div></div></div></div></div>']],
				   [['<div class = bigbox><div class = quad_box><div class = decision-bottom-left><div class = lettersBox><div class = topLeft style="font-size:50px;"><div class = cue-text>'],['</div></div><div class = topMiddle style="font-size:50px;"><div class = cue-text>'],['</div></div><div class = topRight style="font-size:50px;"><div class = cue-text>'],['</div></div><div class = bottomLeft style="font-size:50px;"><div class = cue-text>'],['</div></div><div class = bottomMiddle style="font-size:50px;"><div class = cue-text>'],['</div></div><div class = bottomRight style="font-size:50px;"><div class = cue-text>'],['</div></div></div></div></div>']]]

var center_boards = [[['<div class = bigbox><div class = quad_box><div class = decision-top-left><div class = cue-text>'],['</div></div></div></div>']],
					 [['<div class = bigbox><div class = quad_box><div class = decision-top-right><div class = cue-text>'],['</div></div></div></div>']],
					 [['<div class = bigbox><div class = quad_box><div class = decision-bottom-right><div class = cue-text>'],['</div></div></div></div>']],
					 [['<div class = bigbox><div class = quad_box><div class = decision-bottom-left><div class = cue-text>'],['</div></div></div></div>']]]
...
var pathSource = "/static/experiments/spatial_task_switching_with_directed_forgetting/images/"
var images = []
...
var post_task_block = {
   type: 'survey-text',
   data: {
       exp_id: "spatial_task_switching_with_directed_forgetting",
...
var spatial_task_switching_with_directed_forgetting_experiment = [];

spatial_task_switching_with_directed_forgetting_experiment.push(practiceNode);
spatial_task_switching_with_directed_forgetting_experiment.push(feedback_block);

spatial_task_switching_with_directed_forgetting_experiment.push(start_test_block);
spatial_task_switching_with_directed_forgetting_experiment.push(testNode);
spatial_task_switching_with_directed_forgetting_experiment.push(feedback_block);

spatial_task_switching_with_directed_forgetting_experiment.push(post_task_block);
spatial_task_switching_with_directed_forgetting_experiment.push(end_block);
